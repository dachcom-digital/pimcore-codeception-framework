...
use Dachcom\Codeception\Support\Util\DbHelper;
use Dachcom\Codeception\Support\Util\KernelHelper;
...
class PimcoreCore extends Symfony
{
    ...
    public const DEFAULT_CONFIG_FILE = 'config_default.yaml';
    ...
    protected function setupDbConnection(): void
    {
        ...
        if (is_array($testBundles)) {
            foreach ($testBundles as $testBundle) {
                ...
                $reflectBundleClass = new \ReflectionClass($testBundle['namespace']);
